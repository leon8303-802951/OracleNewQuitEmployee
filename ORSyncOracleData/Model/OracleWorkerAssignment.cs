...
namespace OracleNewQuitEmployee.ORSyncOracleData.Model.WorkAssignment
{
    using System;
    using System.Collections.Generic;
    ...
    public class TmpOracleReturnObj20230119_3
    {
        [JsonProperty("items")]
        public OracleWorkerAssignment[] Items { get; set; }
    ...
    public class OracleWorkerAssignment
    {
