...
namespace OracleNewQuitEmployee.ORSyncOracleData.Model.WorkerManagerInfo
{

    public class TmpReturnObj20230130
    {
        [JsonProperty("items")]
        public OracleWorkerManagerInfo[] Items { get; set; }
    ...
    public class OracleWorkerManagerInfo
    {
    ...
    {
        [JsonProperty("AssignmentSupervisorId")]
        public string AssignmentSupervisorId { get; set; }
        ...
        [JsonProperty("ManagerAssignmentNumber")]
